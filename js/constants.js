...
//=========================GAME SETTINGS====================
//==========================================================
//PLANETS GENERATION AND ENVIRONMENT
export const OBJECTS_COUNT = 200 //How many planets (of each type) should be generated
export const CHECK_COLLISIONS = true //true if aircraft must not touch the planets
export const SHOW_BOUNDED_BOXES = false
export const MAX_X = 500 //The upper max X of scene, used for planets generation
export const MIN_X = -500 //The lower min X of scene, used for planets generation
export const MAX_Z = 500 //The upper max Z of scene, used for planets generation
export const MIN_Z = -500 //The lower min Z of scene, used for planets generation
export const SKYBOX_SIZE = 5000

//Camera
export const CAMERA_RADIUS = -14  // how far from the object to follow
export const CAMERA_HEIGHT_OFFSET = 10 // how high above the object to place the camera
